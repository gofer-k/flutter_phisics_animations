...
class BermoulliPage extends StatefulWidget {
  final String title;

  const BermoulliPage({super.key, required this.title});

  @override
  State<StatefulWidget> createState() => BermoulliPageState();
}

class BermoulliPageState extends State<BermoulliPage> with TickerProviderStateMixin {
